...
xpdotp   =  1440.0 / (2.0*pi);  % [rev/day]/[rad/min]
...
satrec.epochyr   = str2num(longstr1(18:19));
satrec.epochdays = str2num(longstr1(20:32));
...
if (typerun == 'v') 
    ...
    cardnumb      = str2num(longstr2(1));
    satrec.satnum = str2num(longstr2(3:7));
    satrec.inclo  = str2num(longstr2(9:16));
    satrec.nodeo  = str2num(longstr2(18:25));
    satrec.ecco   = str2num(longstr2(27:33))/1E7;
    satrec.argpo  = str2num(longstr2(35:42));
    satrec.mo     = str2num(longstr2(44:51));
    satrec.no     = str2num(longstr2(53:63));
    revnum        = str2num(longstr2(64:68)); 
end
